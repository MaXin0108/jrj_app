...
!function( $ ) {
	...
	var DPGlobal = {
		...
		headTemplate: '<thead>'+
							'<tr>'+
								'<th class="prev"><i class="icon-arrow-left"><img src="'+sys.contextPath+'/images/left.png"/></i></th>'+
								'<th colspan="5" class="switch"></th>'+
								'<th class="next"><i class="icon-arrow-right"><img src="'+sys.contextPath+'/images/right.png"/></i></th>'+
							'</tr>'+
						'</thead>',
